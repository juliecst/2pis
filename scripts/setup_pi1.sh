#!/usr/bin/env bash
# =============================================================================
# setup_pi1.sh — One-time setup for the Raspberry Pi 1 (camera node)
# =============================================================================
# Run as: bash setup_pi1.sh
# =============================================================================
set -euo pipefail

REPO_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")/.." && pwd)"
SERVICE_NAME="pi1-camera"
...
# On Pi1 (Raspberry Pi 4 hardware) the camera is auto-detected via libcamera; no raspi-config step needed.
...
echo "  Test send   : cd ${REPO_DIR}/pi1 && python3 camera.py --test"

...
# --- Network ---
# Pi5 address: static IP on the museum Goodlife network (GL-net Mango router)
PI5_HOST = "192.168.8.11"
PI5_PORT = 5000
PI5_RECEIVE_ENDPOINT = "/receive_frame"
PI5_STATUS_ENDPOINT   = "/status"
...
# --- Logging ---
LOG_FILE = "/home/pi/pi1-camera.log"

...
Import this instead of 'config' in test files to avoid collisions with pi1's
...
# Re-export every public name so callers can do  `from _pi5cfg import *`
# or `import _pi5cfg as config`.
